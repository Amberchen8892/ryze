...
export default function Login() {
    ...
    <div className="col-12 col-md-7" >
        <h2 style={{color:'#21E6C1', textAlign:'center'}}>Thank you for being a member of RYZE</h2>
        <div id="signup-animation"></div>
    </div>
    <div className="col-12 col-md-5" style={{ display:'flex', justifyContent:'center', alignItems:'center'}} >
    <div className="card custom-card" style={{width:"30vw", height:"60vh"}} shadow >
        <div className="card-body">
            
        <form style={{marginTop:'150px'}} >

        <h3 style={{textAlign:'center', color:'#892CDC'}}> Log In </h3>  <div className="mb-3">
