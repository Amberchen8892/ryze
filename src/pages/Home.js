...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="home">
            ...
            <div className="row">
    <div className="col-12 col-md-6" ><div id="home-data"></div></div>
    <div className="col-12 col-md-6" >
        <div className="glass-card" style={{color: "white"}}>
          <div style={{width:"80%"}} >
          <h1 style={{color:"#29BB89"}}>Credit Score </h1>
          <h1 style={{color:"#892CDC"}}>Monitoring Services</h1>
      <p style={{color:"#f5f8ff", fontSize:"1.2rem", marginBottom:"50px"}}>In today's world, a lot of things depend on your credit-loan approvals, insurance premiums, even the success of job applications. Having a good grasp on your credit can help you get ahead in life and save you time and money.</p>
  ...
  <svg width="13px" height="10px" viewBox="0 0 13 10">
    ...
    <img src={clock} width="25%" height = "25%" alt="Monitoring" />
      ...
      <h1 style={{marginTop:"20px"}}>Credit Monitoring</h1>
    ...
    <img src={report} width="25%" height = "25%" alt="Monitoring" />
      ...
      <h1 style={{marginTop:"20px"}}>Identity Protection</h1>
    ...
    <img src={question} width="25%" height = "25%" alt="Monitoring" />
      ...
      <h1  style={{marginTop:"20px"}}>Credit FQAs</h1>
      <p style={{padding:"0px 10px"}}>Know what your score and reports mean with help from our credit education center.</p>
            ...
            <h1 style={{color:'white', textAlign:'center'}}>What can RYZE do for you?</h1>
            <div >
                <div className="item-one">
                <div className="row">
    <div className="col-12 col-md-6" style={{ display:'flex', justifyContent:'center', alignItems:'center'}}>
        <div id="item-one-graph" style={{width:"40%", height:"50%s"}}></div>
    </div>
    <div className="col-12 col-md-6" style={{display:'flex', justifyContent:'center', alignItems:'center'}}>
        <div className="design-card" >
    <h1>Credit Monitoring</h1>
      <p>A credit monitoring service acts as both a personal assistant and watchdog when it comes to your credit. <span style={{fontSize:"1.2rem", fontWeight:"bold"}}>RYZE's</span> credit report monitoring service gives you frequent access to <span>THREE CREDIT BUREAUS's</span> credit history, so you can check your credit report as often as you like. </p>
      <p style={{marginBottom:"30px"}}>Monthly Membership for just $24.95
      automatically billed to account</p>
      <a href="#" className="cta">
  <span>Start Now</span>
  <svg width="13px" height="10px" viewBox="0 0 13 10">
    ...
    <div className="col-12 col-md-6" style={{ display:'flex', justifyContent:'center', alignItems:'center'}}>
    <div id="item-two-graph" style={{width:"50%", height:"60%"}}></div>
    </div>
    <div className="col-12 col-md-6" style={{paddingTop:"30px", display:'flex', justifyContent:'center', alignItems:'center'}}>
        <div className="design-card" >
    <h1>Identity Protection</h1>
      <p><span style={{fontSize:"1.2rem", fontWeight:"bold"}}>RYZE</span> won't prevent you from being targeted by identity thieves, but it can certainly help mitigate the damage. Getting alerts whenever changes occur on your credit report or to your score can be a great way to cut identity thieves off at the pass.</p>
      <p style={{marginBottom:"30px"}}>Monthly Membership for just $24.95
      automatically billed to account</p>
      <a href="#" className="cta">
  ...
  <svg width="13px" height="10px" viewBox="0 0 13 10">
    ...
    <polyline style={{stroke:"white"}} points="8 1 12 5 8 9"></polyline>
                ...
                <div className="row" style={{marginTop:"50px"}}>
    <div className="col-12 col-md-6" style={{ display:'flex', justifyContent:'center', alignItems:'center'}}>
    <div id="item-three-graph" style={{width:"50%", height:"60%s"}}></div>
    </div>
    <div className="col-12 col-md-6" style={{paddingTop:"30px",display:'flex', justifyContent:'center', alignItems:'center'}} >
        <div className="design-card" >
